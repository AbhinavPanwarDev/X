    ...
    <div>
      <div className="grid grid-cols-12 h-screen w-screen">
        <div className="col-span-3 p-5 ">
          <div className='text-3xl w-fit px-6 py-5 hover:bg-gray-700 rounded-full cursor-pointer transition-all'>
            <FaXTwitter />
          </div>
        ...
        <div className="col-span-5 border-r-[1px] border-l-[1px] border-slate-700"></div>
